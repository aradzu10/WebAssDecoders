...
var wasmBinaryFile = 'AES_embedded.wasm';
...
function _AES_pkg(str){ eval(UTF8ToString(str)); }
...
var real____em_js__AES_pkg = asm["___em_js__AES_pkg"]; asm["___em_js__AES_pkg"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__AES_pkg.apply(null, arguments);
};
...
Module["asm"] = asm;
var ___em_js__AES_pkg = Module["___em_js__AES_pkg"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__AES_pkg"].apply(null, arguments) };
